...
export const WeatherMetricsGrid: React.FC<WeatherMetricsGridProps> = ({ weather }) => {
  const metrics = [
    {
      label: 'বৃষ্টির সম্ভাবনা (Rainfall Chance)',
      value: `${weather.rainChance}%`,
      subtext: weather.rainChance > 50 ? 'উচ্চ সম্ভাবনা (High)' : 'কম সম্ভাবনা (Low)',
      icon: CloudRain,
      iconColor: 'text-blue-500 bg-blue-50 dark:bg-blue-950/50',
    },
    {
      label: 'আর্দ্রতা (Humidity)',
      value: `${weather.humidity}%`,
      subtext: 'বাতাসে জলীয় বাষ্পের পরিমাণ',
      icon: Droplets,
      iconColor: 'text-sky-500 bg-sky-50 dark:bg-sky-950/50',
    },
    {
      label: 'বাতাসের গতি (Wind Speed)',
      value: `${weather.windSpeed} km/h`,
      subtext: `দিক: ${weather.windDirection}`,
      icon: Wind,
      iconColor: 'text-teal-500 bg-teal-50 dark:bg-teal-950/50',
    },
    {
      label: 'ইউভি ইনডেক্স (UV Index)',
      value: `${weather.uvIndex} / 10`,
      subtext: weather.uvIndex > 6 ? 'উচ্চ তেজস্ক্রিয়তা' : 'সহনীয় মাত্রা',
      icon: Sun,
      iconColor: 'text-amber-500 bg-amber-50 dark:bg-amber-950/50',
    },
    {
      label: 'বায়ুচাপ (Pressure)',
      value: `${weather.pressure} hPa`,
      subtext: 'বায়ুমণ্ডলীয় চাপ',
      icon: Gauge,
      iconColor: 'text-indigo-500 bg-indigo-50 dark:bg-indigo-950/50',
    },
    {
      label: 'দৃষ্টিসীমা (Visibility)',
      value: `${weather.visibility} km`,
      subtext: 'পরিষ্কার দৃষ্টিসীমা',
      icon: Eye,
